...
public class TelcoPromo {
    public static void main(String[] args) {
        ...
        System.out.println("Smart Data Usage Offer and price: " + promo.showAllowance(Integer.toString(smart.getDataAllowance()) + "GB", smart.getPromoPrice()));
        System.out.println("Globe Data Usage Offer and price: " + promo.showAllowance(Integer.toString(globe.getDataAllowance()) + "GB", globe.getPromoPrice()));
        System.out.println("Ditto Data Usage Offer and price: " + promo.showAllowance(Integer.toString(ditto.getDataAllowance()) + "GB", ditto.getPromoPrice()));
